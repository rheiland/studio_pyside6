...
from PySide6.QtWidgets import QFrame, QCheckBox, QWidget, QLineEdit, QComboBox, QLabel, QCompleter, QToolTip, QRadioButton, QVBoxLayout, QDialog
from PySide6.QtSvgWidgets import QSvgWidget
from PySide6.QtGui import QValidator, QDoubleValidator
from PySide6.QtCore import Qt, QSortFilterProxyModel, QEvent, QByteArray
...
class QLabelSeparator2(QLabel):
    def __init__(self, text):
        # super(QLabel, self).__init__(text)  # rwh - pyside6 ??
        super().__init__(text)  # rwh - pyside6 ??
...
# class QLineEdit_custom(QLineEdit, OptionBase):
...
class QRadioButton_custom(QRadioButton):
    ...
    def __init__(self, text, parent=None):
        # super(QRadioButton, self).__init__(text, **kwargs)  # rwh pyside
...
class HoverWidget(QWidget):
    ...
    def __init__(self, hover_text=None, parent=None, hover_enabled=True):
        super().__init__(parent)  #rwh pyside
        # super().__init__(QWidget)  #rwh pyside
        # QWidget.__init__(self)  #rwh pyside
...
class HoverSvgWidget(QSvgWidget, HoverWidget):
    def __init__(self, hover_text, parent=None):
        # super().__init__(parent)  # rwh pyside
        # QSvgWidget.__init__(self)  # rwh pyside
        HoverWidget.__init__(self)  # rwh pyside
        self.setHoverText(hover_text)

...
from PySide6.QtWidgets import QApplication, QWidget, QScrollArea, QVBoxLayout,QHBoxLayout, QSlider, QLabel, QMainWindow, QComboBox, QCheckBox, QPushButton, QDoubleSpinBox, QFrame, QSpinBox, QMessageBox

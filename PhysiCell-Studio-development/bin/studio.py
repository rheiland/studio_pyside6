...
from PySide6.QtGui import QPalette, QColor, QIcon, QFont, QAction
...
class PhysiCellXMLCreator(QWidget):
    def __init__(self, config_file, studio_flag, skip_validate_flag, rules_flag, model3D_flag, tensor_flag, exec_file, nanohub_flag, is_movable_flag, pytest_flag, biwt_flag, parent = None):
        ...
        print("---------- studio.py:  past self.config_tab.fill_gui()")
    ...
    def tab_change_cb(self,index: int):
        ...
        # if index == 0:
        #     studio_app.resize(1101,770) # recall: print("size=",ex.size())  # = PySide6.QtCore.QSize(1100, 770)
        #     studio_app.resize(1101,970) # recall: print("size=",ex.size())  # = PySide6.QtCore.QSize(1100, 770)
    ...
    def about_pyqt(self):
        ...
        about_text = """ 
PhysiCell Studio is developed using PySide6.<br><br>

For licensing information:<br>
<a href="https://github.com/PySide6/PyQt/blob/master/LICENSE">github.com/PySide6/PyQt/blob/master/LICENSE</a>
...
def main():
    ...
    print("size=",ex.size())  # = PySide6.QtCore.QSize(1100, 770)
    # ex.setFixedWidth(1101)  # = PySide6.QtCore.QSize(1100, 770)
    # print("width=",ex.size())
    ...
    # ex.repaint()
    # ex.show()
    # print("size 2=",ex.size())  # = PySide6.QtCore.QSize(1100, 770)

    # startup_notice()

    # sys.exit(studio_app.exec_())  # rwh pyside
    studio_app.exec()

...
from PySide6.QtGui import QIcon, QFont, QStandardItemModel, QValidator
from PySide6.QtGui import QRegularExpressionValidator
from PySide6.QtCore import QRegularExpression
# rwh pyside6
# from studio_classes import QLabelSeparator2, ExtendedCombo, QLineEdit_custom, OptionalDoubleValidator, DoubleValidatorOpenInterval, DoubleValidatorWidgetBounded, AttackRateValidator, QRadioButton_custom, HoverWarning, HoverQuestion, StudioTab, QComboBox_custom, QCheckBox_custom
from studio_classes import QRadioButton_custom
from studio_classes import QLabelSeparator2, ExtendedCombo, QLineEdit_custom, OptionalDoubleValidator, DoubleValidatorOpenInterval, DoubleValidatorWidgetBounded, AttackRateValidator,  HoverWarning, HoverQuestion, StudioTab, QComboBox_custom, QCheckBox_custom
...
"""
    ...
    def create_death_tab(self):
        ...
        self.apoptosis_rb1 = QRadioButton("transition rate     ")  # rwh pyside
        ...
        self.apoptosis_rb2 = QRadioButton("duration")  #rwh pyside
        ...
        # self.necrosis_rb1 = QRadioButton("transition rate     ")  # rwh pyside
        self.necrosis_rb1.toggled.connect(self.necrosis_phase_transition_cb)

        self.necrosis_rb2 = QRadioButton_custom("duration", parent=self)  # rwh pyside
        # self.necrosis_rb2 = QRadioButton("duration")
    ...
    def create_motility_tab(self):
        ...
        # self.chemotaxis_direction_towards = QRadioButton_custom("towards")  #rwh pyside
        ...
        # self.chemotaxis_direction_against = QRadioButton_custom("against") #rwh pyside
    ...
    def create_interaction_tab(self):
        ...
        # self.attack_rate = QLineEdit_custom()  # rwh pyside
    ...
    def add_row_custom_table(self, row_num):
        ...
        for irow in [row_num]:
            ...
            rx_valid_varname = QRegularExpression("^[a-zA-Z][a-zA-Z0-9_]+$")
            name_validator = QRegularExpressionValidator(rx_valid_varname )
    ...
    def create_miscellaneous_tab(self):
        ...
        par_dist_label = QLabelSeparator2("Parameter Distributions")

...
from PySide6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QFrame, QLabel, QPushButton, QStackedWidget, QGridLayout, QLineEdit, QTabWidget, QTableWidget, QTableWidgetItem, QMessageBox, QRadioButton
#rwh pyside6
...
from studio_classes import  QHLine, QComboBox_custom, CellDefSubTab, QCheckBox_custom, HoverWarning, QLineEdit_custom
...
class CycleTab(CellDefSubTab):
    ...
    def create_base_cycle_tab(self):
        ...
        self.cycle_rb1 = QRadioButton_custom("transition rate(s)      ")   # rwh pyside
        ...
        self.cycle_rb2 = QRadioButton_custom("duration(s)")   # rwh pyside
    ...
    def update_cycle_params(self):
        ...
        print("--------- rwh: param_d= ",self.param_d[cdname])
        print("--------- rwh2: param_d items()= ",self.param_d[cdname].items())
        for k, v in self.param_d[cdname].items():
            print(f"--------- rwh2: k,v= {k}, {v}")
            if k == None:   # rwh pyside
                break

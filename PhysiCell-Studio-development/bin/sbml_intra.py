...
from PySide6.QtWidgets import QFrame,QApplication,QWidget,QTabWidget,QLineEdit, QGroupBox,QHBoxLayout,QVBoxLayout,QRadioButton,QLabel,QCheckBox,QComboBox,QScrollArea,QGridLayout,QPushButton,QFileDialog,QTableWidget,QTableWidgetItem,QHeaderView
from PySide6.QtWidgets import QMessageBox, QCompleter, QSizePolicy
from PySide6.QtCore import QSortFilterProxyModel, Qt, QRect
...
# Target fluid fraction          v       vff       vff\n"
    ...
    def create_mapping_table(self):
        ...
        for irow in range(self.max_map_table_rows):
            ...
            w_me = MyQLineEdit()
            w_me.setFrame(False)
            # rx_valid_varname = QtCore.QRegExp("^[a-zA-Z][a-zA-Z0-9_]+$")  # rwh pyside
            rx_valid_varname = QRegularExpressionValidator("^[a-zA-Z][a-zA-Z0-9_]+$")

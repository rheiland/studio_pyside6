...
from PySide6.QtWidgets import QFrame,QApplication,QWidget,QTabWidget,QLineEdit,QHBoxLayout,QVBoxLayout,QRadioButton,QPushButton, QLabel,QCheckBox,QComboBox,QScrollArea,QGridLayout, QFileDialog,QSpinBox,QDoubleSpinBox, QButtonGroup    # , QMessageBox
# from PySide6.QtWidgets import QMessageBox

#rwh pyside6
# from studio_classes import QLabelSeparator2, QLineEdit_custom, QCheckBox_custom, QRadioButton_custom, HoverWarning, StudioTab
from studio_classes import QLabelSeparator2, QLineEdit_custom, QCheckBox_custom,  HoverWarning, StudioTab
...
class Config(StudioTab):
    ...
    def __init__(self, xml_creator):
        ...
        #============  Domain ================================
        # label = QLabelSeparator2("Domain (micron)")
        ...
        #============  Misc ================================
        # label = QLabelSeparator2("Misc runtime parameters")
        ...
        print("rwh: --------- got past random_seed_integer ")
        # self.random_seed_integer = QLineEdit()
        ...
        print("rwh: --------- got past random_seed_integer 2")
        ...
        #------------------
        print("rwh: --------- pre hbox 1")
        hbox = QHBoxLayout()
        print("rwh: --------- post hbox 1")
        ...
        #============  Cells IC ================================
        # label = QLabelSeparator2("Initial conditions of cells (x,y,z, type)")
        ...
        #============  Cell behavior flags ================================
        # label = QLabelSeparator2("Cells' global behaviors")

...
from PySide6.QtWidgets import QFrame,QApplication,QWidget,QTabWidget,QFormLayout,QLineEdit, QHBoxLayout,QVBoxLayout,QRadioButton,QLabel,QCheckBox,QComboBox,QScrollArea,  QMainWindow,QGridLayout, QPushButton, QFileDialog, QMessageBox, QStackedWidget, QSplitter
from PySide6.QtGui import QPixmap
# from PySide6.QtCore import QRegExpValidator
...
class ICs(QWidget):
    ...
    def create_base_ics_tab(self):
        ...
        csv_validator = QRegularExpressionValidator(QtCore.QRegExp(r'^.+\.csv$'))
